...
public class JWTTokenUtil {
	 ...
	 * 产生token
	 * @param obj 登录用户对象
	 * @param ttlMillis 有效时长：如10分钟，则为10*60*1000，-1不设有效时长
	 * @return
	 */
	public String createJWTToken(Object obj, long ttlMillis){
		//We will sign our JWT with our ApiKey secret
		String secret =StringUtils.isEmpty(AppPropUtil.get("lark.jwt.secret"))?"123456" : AppPropUtil.get("lark.jwt.secret");
